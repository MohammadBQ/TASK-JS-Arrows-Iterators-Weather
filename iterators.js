...
const fehtemps = temperatures.map ( (temperatures) => (temperatures - 32) * (5/9)
)
...
const filtering = temperatures.filter((temperatures) => temperatures > threshhold
)
return filtering
};
...
const logHottestDays = function (temperatures, threshhold) {
    ...
    const Tempstocels = toCelsius(filteredTemps)
    logger(Tempstocels)
};
